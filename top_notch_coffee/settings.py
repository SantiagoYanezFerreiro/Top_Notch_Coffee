"""
Django settings for Top Notch Coffee project.
...
ALLOWED_HOSTS = ['topnotchcoffee.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'top_notch_coffee.urls'
...
# Internationalization django configuration
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'topnotchoffeeawsbucket'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'topnotchcoffee@example.com'
else:
